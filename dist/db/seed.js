...
async function main() {
    ...
    try {
        ...
        await client.query(`INSERT INTO qa_runs (
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        ON CONFLICT (id) DO UPDATE SET
          ...
          notes = EXCLUDED.notes`, [artifact[0], qaRunId, ...artifact.slice(1)]);
        }
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        for (const check of checks) {
            await client.query(`INSERT INTO check_results (
        ...
        ON CONFLICT (id) DO UPDATE SET
          ...
          primary_evidence_id = EXCLUDED.primary_evidence_id`, [check[0], qaRunId, ...check.slice(1)]);
        }
        const events = [
        ...
        for (const event of events) {
            await client.query(`INSERT INTO run_events (id, qa_run_id, event_at, event_type, message, metadata_json)
        VALUES ($1, $2, $3, $4, $5, $6::jsonb)
        ON CONFLICT (id) DO UPDATE SET
          event_at = EXCLUDED.event_at,
          event_type = EXCLUDED.event_type,
          message = EXCLUDED.message,
          metadata_json = EXCLUDED.metadata_json`, [event[0], qaRunId, event[1], event[2], event[3], JSON.stringify(event[4])]);
        }
